            ...
            <div style={{ padding: '10px 4px 0' }}>
              ...
              {popularStocks.map((s) => (
                <a
                  key={s}
                  href={`/stocks/${s}`}
                  style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '7px 12px', borderRadius: 8, textDecoration: 'none', color: 'rgba(255,255,255,0.45)', fontSize: 13, fontWeight: 500, transition: 'all 0.15s' }}
                >
                  <span>{s}</span>
          ...
          <div style={{ maxWidth: 720, margin: '0 auto', padding: '28px 20px 64px' }}>
            ...
            <div style={{ borderRadius: 20, border: '1px solid rgba(255,255,255,0.08)', background: '#0a0a0a', overflow: 'hidden', marginBottom: 10 }}>
              <div style={{ padding: '24px 24px 0' }}>
                ...
                {/* Period tabs */}
                <div style={{ display: 'flex', gap: 2, padding: '10px 0', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                  {['1W', '1M', '3M', '6M', '1Y', 'Max'].map((p, i) => (
                    <button
                      key={p}
                      style={{ padding: '5px 11px', borderRadius: 7, fontSize: 12, fontWeight: 500, border: 'none', cursor: 'pointer', background: i === 1 ? 'rgba(255,255,255,0.1)' : 'transparent', color: i === 1 ? '#fff' : '#52525b', transition: 'all 0.15s' }}
                    >
                      {p}
                    </button>
                  ))}
                  <div style={{ flex: 1 }} />
                  <span style={{ fontSize: 11, color: '#3f3f46', alignSelf: 'center', paddingRight: 4 }}>30-day chart</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8, marginBottom: 10 }}>
              {stats.map((s) => (
                <div
                  key={s.label}
                  style={{ borderRadius: 14, border: '1px solid rgba(255,255,255,0.07)', background: '#0a0a0a', padding: '13px 16px' }}
                >
            ...
            {/* ──────────────────────────────────────────────────────────────── */}
            <div
              style={{ borderRadius: 20, border: '1px solid rgba(52,211,153,0.18)', background: 'rgba(52,211,153,0.03)', padding: '20px 22px', marginBottom: 10, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16 }}
            >
              <div style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: 16, fontWeight: 700, color: '#fff', margin: '0 0 4px', letterSpacing: '-0.01em' }}>
                  Trade {symbol} with €1,000,000 virtual cash
                </p>
                <p style={{ fontSize: 13, color: '#71717a', margin: 0 }}>
                  Real market prices · No financial risk · Compete on the leaderboard
                </p>
              </div>
              <a
                href="https://apps.apple.com/us/app/invest-stock-simulator/id6761500263"
                style={{ flexShrink: 0, display: 'inline-flex', alignItems: 'center', gap: 5, background: '#fff', color: '#000', fontSize: 13, fontWeight: 700, padding: '11px 20px', borderRadius: 12, textDecoration: 'none', whiteSpace: 'nowrap' }}
              >
                Try Free
            ...
            <div style={{ borderRadius: 20, border: '1px solid rgba(255,255,255,0.07)', background: '#0a0a0a', padding: '22px 24px', marginBottom: 10 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                {[
                  ...
                  <div
                    key={i}
                    style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '11px 0', borderBottom: i < 4 ? '1px solid rgba(255,255,255,0.04)' : 'none' }}
                  >
